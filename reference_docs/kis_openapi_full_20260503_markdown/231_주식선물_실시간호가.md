...
|개요|||||||
|개요|※ 선물옵션 호가 데이터는 0.2초 필터링 옵션이 있습니다._x000D_<br>  필터링 사유는 순간적으로 데이터가 폭증할 경우 서버 뿐만아니라 클라이언트 환경에도 부하를 줄 수 있어 적용된 사항인 점 양해 부탁드립니다.||||||
|Layout|||||||
...
|Response Header|||||||
|Response Body|FUTS_SHRN_ISCD|선물단축종목코드|object|Y|9|'각 항목사이에는 구분자로 ^ 사용,_x000D_<br>모든 데이터타입은 String으로 변환되어 push 처리됨'|
...
|Example|||||||
|Request Example (Python)|{_x000D_<br>    "header": {_x000D_<br>        "approval_key": "35xxxxxa-bxxa-4xxb-87xxx-f56xxxxxxxxxx",_x000D_<br>        "custtype": "P",_x000D_<br>        "tr_type": "1",_x000D_<br>        "content-type": "utf-8"_x000D_<br>    },_x000D_<br>    "body": {_x000D_<br>        "input": {_x000D_<br>            "tr_id": "H0ZFASP0",_x000D_<br>            "tr_key": "111V06"_x000D_<br>        }_x000D_<br>    }_x000D_<br>}||||||
|Response Example|# 연결 확인_x000D_<br>{_x000D_<br>    "header": {_x000D_<br>        "tr_id": "H0ZFASP0", _x000D_<br>        "tr_key": "111V06", _x000D_<br>        "encrypt": "N"_x000D_<br>        }, _x000D_<br>    "body": {_x000D_<br>        "rt_cd": "0", _x000D_<br>        "msg_cd": "OPSP0000",_x000D_<br>        "msg1": "SUBSCRIBE SUCCESS", _x000D_<br>        "output": {_x000D_<br>            "iv": "0123456789abcdef", _x000D_<br>            "key": "abcdefghijklmnopabcdefghijklmnop"}_x000D_<br>        }_x000D_<br>}_x000D_<br>_x000D_<br># output_x000D_<br>0\|H0ZFASP0\|001\|111V06^092304^79700^79800^79900^80000^80200^80300^80500^81100^8490_x000D_<br>0^85900^79500^79400^79300^79200^79100^79000^78900^78800^78700^78600^1^18^6^2^2^1^3^1^1^1^8^6^4^8^4^_x000D_<br>8^7^11^11^3^950^4148^988^6^9^1^3^15^5^10^4404^2277^1321^3440^330^2237^1835^362^83^15^36^97^6135^165_x000D_<br>09^950^0||||||
