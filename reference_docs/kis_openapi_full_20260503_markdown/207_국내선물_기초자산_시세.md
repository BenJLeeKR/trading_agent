...
|개요|||||||
|개요|국내선물 기초자산 시세 API입니다. _x000D_<br>한국투자 HTS(eFriend Plus) &gt; [0503] 선물옵션 종합시세(Ⅰ) 화면의 "상단 바" 기능을 API로 개발한 사항으로, 해당 화면을 참고하시면 기능을 이해하기 쉽습니다.||||||
|Layout|||||||
...
|Example|||||||
|Request Example (Python)|fid_cond_mrkt_div_code:F_x000D_<br>fid_input_iscd:101V06_x000D_<br>fid_cond_mrkt_div_code1:_x000D_<br>fid_cond_scr_div_code:_x000D_<br>fid_mtrt_cnt:_x000D_<br>fid_cond_mrkt_cls_code:||||||
|Response Example|{_x000D_<br>    "output1": {_x000D_<br>        "unas_prpr": "367.25",_x000D_<br>        "unas_prdy_vrss": "-3.47",_x000D_<br>        "unas_prdy_vrss_sign": "5",_x000D_<br>        "unas_prdy_ctrt": "-0.94",_x000D_<br>        "unas_acml_vol": "161725000",_x000D_<br>        "hts_kor_isnm": "F 202406",_x000D_<br>        "futs_prpr": "369.35",_x000D_<br>        "futs_prdy_vrss": "-3.45",_x000D_<br>        "prdy_vrss_sign": "5",_x000D_<br>        "futs_prdy_ctrt": "-0.93"_x000D_<br>    },_x000D_<br>    "output2": [],_x000D_<br>    "rt_cd": "0",_x000D_<br>    "msg_cd": "MCA00000",_x000D_<br>    "msg1": "정상처리 되었습니다."_x000D_<br>}||||||
