...
|개요|||||||
|개요|(야간)선물옵션 증거금상세 API입니다._x000D_<br>한국투자 HTS(eFriend Plus) &gt; [2537] 야간선물옵션 증거금상세 화면 의 기능을 API로 개발한 사항으로, 해당 화면을 참고하시면 기능을 이해하기 쉽습니다.||||||
|Layout|||||||
...
||output1|응답상세|object array|Y||array_x000D_<br>아래 18가지 항목이 순서대로 출력됨_x000D_<br>(1) A. 신규증거금 - 선물 - 1.개별종목_x000D_<br>(2) A. 신규증거금 - 선물 - 2.스프레드_x000D_<br>(3) A. 신규증거금 - 3. ﻿﻿﻿옵션매수증거금_x000D_<br>﻿﻿(4) A. 신규증거금 - 4. 옵션매도증거금_x000D_<br>﻿﻿(5) A. 소계(1+2+3+4)_x000D_<br>(6) B. 순위험증거금 - 1. ﻿﻿가격변동증거금_x000D_<br>(7) B. 순위험증거금 - 2. ﻿﻿﻿선물스프레드증거금_x000D_<br>﻿﻿(8) B. 순위험증거금 - 3. 인수수도 증거금 등_x000D_<br>(9) B. 순위험증거금 - 4. 최소증거금_x000D_<br>(10) B. 순위험증거금 - 5. 옵션가격증거금_x000D_<br>(11) B. 순위험증거금 - 6. 총위험증거금_x000D_<br>(12) B. 소계SUM상품군별MAX[{MAX(1+2+3,4)+5},6]_x000D_<br>(13) C. 결제예정금액 - 1. ﻿﻿﻿당일옵션매수금액_x000D_<br>(14) ﻿﻿C. 결제예정금액 - 2. 당일옵션매도금액_x000D_<br>(15) C. 결제예정금액 - 3. ﻿﻿당일선물손실_x000D_<br>﻿﻿﻿(16) C. 결제예정금액 - 4. 당일선물이익 _x000D_<br>(17) C.소계(1-2+3-4)_x000D_<br>(18) (A)+B+(C)|
||cash_amt|현금금액|string|Y|19||
||tot_amt|총금액|string|Y|19||
||output2|응답상세|object array|Y||array_x000D_<br>아래 5가지 항목이 순서대로 출력됨_x000D_<br>(1) 예수금_x000D_<br>(2) 인출가능금액_x000D_<br>(3) 주문가능금액_x000D_<br>﻿﻿(4) 위탁증거금액_x000D_<br>﻿﻿(5) 추가증거금액_x000D_<br>_x000D_<br>※ 인출가능금액은 정산 후 인출가능 예정 금액입니다._x000D_<br>현재 시점 실제 인출 가능금액은 정규장, 야간시장 인출가능금액 중 적은 금액 기준입니다.|
||cash_amt|현금금액|string|Y|19||
...
|Example|||||||
|Request Example (Python)|CANO:12345678_x000D_<br>ACNT_PRDT_CD:03_x000D_<br>MGNA_DVSN_CD:01||||||
|Response Example|{_x000D_<br>    "output1": [_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        }_x000D_<br>    ],_x000D_<br>    "output2": [_x000D_<br>        {_x000D_<br>            "cash_amt": "100000000",_x000D_<br>            "sbst_amt": "0",_x000D_<br>            "tot_amt": "100000000"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "100000000",_x000D_<br>            "sbst_amt": "0",_x000D_<br>            "tot_amt": "100000000"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "100000000",_x000D_<br>            "sbst_amt": "0",_x000D_<br>            "tot_amt": "100000000"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "sbst_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        },_x000D_<br>        {_x000D_<br>            "cash_amt": "0",_x000D_<br>            "sbst_amt": "0",_x000D_<br>            "tot_amt": "0"_x000D_<br>        }_x000D_<br>    ],_x000D_<br>    "output3": {_x000D_<br>        "bfdy_sbst_sll_sbst_amt": "0",_x000D_<br>        "thdt_sbst_sll_sbst_amt": "0",_x000D_<br>        "bfdy_sbst_sll_ccld_amt": "0",_x000D_<br>        "thdt_sbst_sll_ccld_amt": "0",_x000D_<br>        "opt_buy_exus_acnt_yn": "N",_x000D_<br>        "base_dpsa_gdat_grad_cd": "03",_x000D_<br>        "opt_dfpa": "0",_x000D_<br>        "excc_dfpa": "0",_x000D_<br>        "fee_amt": "0",_x000D_<br>        "nxdy_dncl_amt": "100000000",_x000D_<br>        "prsm_dpast_amt": "100000000",_x000D_<br>        "opt_base_dpsa_gdat_grad_cd": "01"_x000D_<br>    },_x000D_<br>    "rt_cd": "0",_x000D_<br>    "msg_cd": "KIOK0510",_x000D_<br>    "msg1": "조회가 완료되었습니다                                                           "_x000D_<br>}||||||
