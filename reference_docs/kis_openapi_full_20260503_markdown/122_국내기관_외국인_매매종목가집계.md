...
|개요|||||||
|개요|국내기관_외국인 매매종목가집계 API입니다._x000D_<br>_x000D_<br>HTS(efriend Plus) [0440] 외국인/기관 매매종목 가집계 화면을 API로 구현한 사항으로 화면을 함께 보시면 기능 이해가 쉽습니다._x000D_<br>_x000D_<br>증권사 직원이 장중에 집계/입력한 자료를 단순 누계한 수치로서, _x000D_<br>입력시간은 외국인 09:30, 11:20, 13:20, 14:30 / 기관종합 10:00, 11:20, 13:20, 14:30 이며, _x000D_<br>입력한 시간은 ±10분정도 차이가 발생할 수 있으며, 장운영 사정에 다라 변동될 수 있습니다.||||||
|Layout|||||||
...
||FID_INPUT_ISCD|입력 종목코드|string|Y|12|0000:전체, 0001:코스피, 1001:코스닥_x000D_<br>..._x000D_<br>포탈 (FAQ : 종목정보 다운로드(국내) - 업종코드 참조)|
...
||frgn_ntby_tr_pbmn|외국인 순매수 거래 대금|string|Y|18|frgn_ntby_tr_pbmn ~ etc_corp_ntby_tr_pbmn_x000D_<br>(단위 : 백만원, 수량*현재가)|
