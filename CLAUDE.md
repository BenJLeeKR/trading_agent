...
- `.env` 파일은 직접 수정하지 않는다.
- 완료 주장 전에는 `docs/20_harness_engineering/definition_of_done.md` 기준을 확인한다.
...
- `docs/20_harness_engineering/` 문서
- 이 파일
