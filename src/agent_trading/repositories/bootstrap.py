...
from agent_trading.repositories.memory import (
    ...
    InMemoryKisFillCumulativeStateRepository,
...
def build_in_memory_repositories() -> RepositoryContainer:
    repos = RepositoryContainer(
        ...
        kis_fill_cumulative_state=InMemoryKisFillCumulativeStateRepository(),
        ...
        fdc_quota=InMemoryFdcQuotaRepository(),
    )
