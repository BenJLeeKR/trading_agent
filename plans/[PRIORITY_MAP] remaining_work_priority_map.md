...
> aggregate가 낮아지는 효과도 상당 부분 기여했다. **가장 중요한
...
0. **BUY 주문 0건 근본 복구 (2026-07-14 신설, 최우선)**
  ...
  이후 §2.24/§14 ablation으로 보정됨)**: `regime_conditional_
   ...
   - **SPPV-2.33(완료, 2026-07-16, R3b aggregate 우위 vs 대응표본
     ...
     왔다.** **가장 중요한 발견: 분기3에서 이번 pooled 교체효과
   ...
   - **SPPV-3(다음 착수: 분기3처럼 pooled/paired 부호가 갈리는
     구간의 거래일 단위 세밀 진단 + R3b 구성 효과와 활동성 필터의
     ...
     R3b도 다시 Watch로 하향됐다. §2.33의 3분해는 그 aggregate
     우위가 부분적으로는 실체가 있지만(added_only 우수성) 비대칭적
     이고 특정 구간 집중형임을 확인해 Watch 판정을 유지할 근거를
     더했다.** 한편 **§2.23~§2.26에서 결합 사용
     ...
     단계에 머문다.** 다음 착수 형태는 분기3처럼 pooled/paired
     부호가 갈리는 구간의 거래일 단위 세밀 진단, R3b 구성 효과와
