...
`bearish_trend`로 분류된 거래일이 30일 이상이면 `TRIGGERED`. 산출:
`logs/regime_switch_v1_gate_monitor_2026-07-17.json`, 실행 로그
`logs/regime_switch_v1_gate_monitor_run_2026-07-17.log`(신규 KIS
호출 0건 — 벤치마크 KODEX 200 캐시로 전량 서빙).
