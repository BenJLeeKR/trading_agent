...
- **BUY 주문 0건 근본 복구 — 신호 예측력·`entry_score`·전체 주문 funnel 재설계**
  ...
  - **SPPV-2.33(완료, 2026-07-16, R3b aggregate 우위 vs 대응표본
    ...
    차이의 상당 부분이 "구성 효과"에서도 왔다.** **가장 중요한
  ...
  - **SPPV-3(다음 착수: 분기3처럼 pooled/paired 부호가 갈리는 구간의
    거래일 단위 세밀 진단 + R3b 구성 효과와 활동성 필터의 상호작용
    확인 + 더 긴 표본으로 재평가 + §3 전제조건 충족 후 alpha 교체
    ...
    다시 Watch로 하향됐다. §2.33의 3분해는 그 aggregate 우위가
    부분적으로는 실체가 있지만(added_only 우수성) 비대칭적이고
    특정 구간 집중형임을 확인해 Watch 판정을 유지할 근거를
