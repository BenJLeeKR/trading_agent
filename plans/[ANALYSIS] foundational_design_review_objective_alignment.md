...
- 수정내용: §2.32의 overlap(간접) 근거를 대응표본(직접) 검증으로
  ...
  절반 미만)로 뒤집혔다.** t_NW가 1.96 이상인 창은 2개(2차,
  전반부)뿐이고 나머지는 marginal했다. R0 vs R3 대체쌍은 더 약해
...
- **3순위(보류 유지, 형태 재정의 — 우선순위 재조정)**: **`entry_
  ...
  **§2.28~§2.29에서 그 Conditional Go가 실제 virtual BUY funnel
  ...
  드러나 R3b도 다시 Watch로 하향됐다.** 한편 **§2.23~§2.27에서
  ...
  SPPV-3의 다음 착수 항목은 R3b의 aggregate 우위와 대체쌍 성과
  불일치 원인 규명, 더 긴 표본으로 재평가, alpha 교체의 §3
