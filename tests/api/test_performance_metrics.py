...
class TestPerformanceMetrics:
    ...
    def test_invalid_account_id_preserves_string_detail(
        ...
        """invalid account_id는 기존 문자열 detail을 유지한다."""
        response = empty_client.get(
            "/performance-metrics",
            params={
    ...
    def test_invalid_start_date_preserves_string_detail(
        ...
        """invalid start_date는 기존 문자열 detail을 유지한다."""
        acct_id = "00000000-0000-0000-0000-000000000001"
        response = empty_client.get(
            "/performance-metrics",
            params={
    ...
    def test_invalid_end_date_preserves_string_detail(
        ...
        """invalid end_date는 기존 문자열 detail을 유지한다."""
        acct_id = "00000000-0000-0000-0000-000000000001"
        response = empty_client.get(
            "/performance-metrics",
            params={
    ...
    def test_invalid_date_range_preserves_string_detail(
        ...
        """invalid date range는 기존 문자열 detail을 유지한다."""
        acct_id = "00000000-0000-0000-0000-000000000001"
        response = empty_client.get(
            "/performance-metrics",
            params={
    ...
    def test_invalid_strategy_id_preserves_string_detail(
        ...
        """invalid strategy_id는 기존 문자열 detail을 유지한다."""
        acct_id = "00000000-0000-0000-0000-000000000001"
        response = empty_client.get(
            "/performance-metrics",
            params={
