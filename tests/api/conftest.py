...
async def seeded_repos(
    ...
    await repos.risk_limit_snapshots.add(
        RiskLimitSnapshotEntity(
            ...
            portfolio_var_1d=Decimal("150000"),
            portfolio_var_1d_adjusted=Decimal("165000"),
            largest_var_symbol="005930",
            largest_var_contribution_pct=Decimal("35.5"),
            concentration_penalty_pct=Decimal("10.0"),
            var_status="ready",
            var_reason_codes=["phase1_ready"],
            symbol_var_json={"005930": 150000},
            symbol_marginal_contribution_json={"005930": 35.5},
