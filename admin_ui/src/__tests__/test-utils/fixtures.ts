...
export const mockTradeDecisions: TradeDecisionDetail[] = [
  {
    trade_decision_id: "aaaaaaaa-bbbb-cccc-dddd-eeeeeeee00td1",
    decision_context_id: "aaaaaaaa-bbbb-cccc-dddd-eeeeeeee00dc1",
    intent: "Buy AAPL — strong earnings outlook",
    ticker: "AAPL",
    side: "buy",
    qty: "100",
    confidence: 0.85,
    agent_label: "FinalDecisionComposer",
    created_at: "2026-05-05T00:00:00Z",
  },
  {
    trade_decision_id: "aaaaaaaa-bbbb-cccc-dddd-eeeeeeee00td2",
    decision_context_id: "aaaaaaaa-bbbb-cccc-dddd-eeeeeeee00dc1",
    intent: "Hold TSLA — market uncertainty",
    ticker: "TSLA",
    side: "hold",
    qty: "0",
    confidence: 0.55,
    agent_label: "AIRiskAgent",
  ...
  },
  {
    ...
    intent: "Sell MSFT — stop-loss triggered",
    ticker: "MSFT",
    side: "sell",
    qty: "50",
    confidence: 0.25,
    agent_label: "EventInterpretation",
