...
// Mock data
const ordersData = [
  { id: "ORD-20240115-001", symbol: "AAPL", side: "매수", quantity: 100, status: "체결", createdAt: "2024-01-15 14:32:15", price: 185.50, dcId: "DC-001", tdId: "TD-001" },
  { id: "ORD-20240115-002", symbol: "MSFT", side: "매도", quantity: 50, status: "부분체결", createdAt: "2024-01-15 14:28:42", price: 378.75, dcId: "DC-002", tdId: "TD-002" },
  { id: "ORD-20240115-003", symbol: "GOOGL", side: "매수", quantity: 25, status: "실행중", createdAt: "2024-01-15 14:25:19", price: 142.30, dcId: "DC-003", tdId: "TD-003" },
  { id: "ORD-20240115-004", symbol: "TSLA", side: "매도", quantity: 30, status: "체결", createdAt: "2024-01-15 14:20:08", price: 238.50, dcId: "DC-004", tdId: "TD-004" },
  { id: "ORD-20240115-005", symbol: "NVDA", side: "매수", quantity: 15, status: "거부", createdAt: "2024-01-15 14:15:33", price: 875.20, dcId: "DC-005", tdId: "TD-005" },
  { id: "ORD-20240115-006", symbol: "AMD", side: "매수", quantity: 80, status: "체결", createdAt: "2024-01-15 14:10:22", price: 168.40, dcId: "DC-006", tdId: "TD-006" },
]

const stateEventsData = [
  { id: 1, state: "생성", timestamp: "2024-01-15 14:32:15", message: "주문 생성됨" },
  { id: 2, state: "제출", timestamp: "2024-01-15 14:32:16", message: "브로커에 제출됨" },
  { id: 3, state: "접수", timestamp: "2024-01-15 14:32:17", message: "브로커 접수 완료" },
  { id: 4, state: "체결", timestamp: "2024-01-15 14:32:25", message: "100주 전량 체결" },
]

const brokerOrdersData = [
  { id: "BRK-001", odno: "123456789", quantity: 100, filledQty: 100, status: "체결", avgPrice: 185.50 },
]
...
export function OrderTracking() {
  ...
  const orderColumns = [
    ...
    { key: "price", header: "가격", render: (value: number) => `$${value.toFixed(2)}` },
  ...
  const brokerColumns = [
    ...
    { key: "avgPrice", header: "평균가", render: (value: number) => `$${value.toFixed(2)}` },
  ]
            ...
            <div className="bg-white rounded-xl border border-[#e2e8f0] p-5">
              ...
              <dl className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <dd className="text-sm font-medium text-[#0f172a] mt-0.5">${selectedOrder.price.toFixed(2)}</dd>
                </div>
              </dl>
            </div>
