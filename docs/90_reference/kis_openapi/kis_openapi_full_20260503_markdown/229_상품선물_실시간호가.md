...
|Request Body|tr_id|거래ID|string|Y|7|H0CFASP0|
||tr_key|종목코드|string|Y|6|종목코드|
|Response Header|||||||
|Response Body|FUTS_SHRN_ISCD|선물 단축 종목코드|object|Y|32|'각 항목사이에는 구분자로 ^ 사용,_x000D_<br>모든 데이터타입은 String으로 변환되어 push 처리됨'|
