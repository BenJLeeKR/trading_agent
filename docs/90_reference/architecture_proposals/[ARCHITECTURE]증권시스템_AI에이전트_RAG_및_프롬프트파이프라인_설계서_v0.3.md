# 증권 AI 에이전트 아키텍처 및 프롬프트 파이프라인 설계서 (v0.3)
...
| :---: | :---: | :--- | :--- | :--- |
| v0.1 | 2026-06-21 | 시스템 | 증권 AI 에이전트 RAG 및 프롬프트 파이프라인 설계 | 아키텍처총괄 |
| v0.2 | 2026-06-21 | Gemini | 증권 AI 에이전트 RAG 및 프롬프트 파이프라인 설계 | 메타정보총괄 |
| v0.3 | 2026-06-21 | ChatGPT | META 시스템 v0.5.2 및 명명규칙 v0.2 기준 반영. `STD_TBL_NM`/`PHYS_TBL_NM`/`LOGIC_TBL_NM` 용어 정합화, RAG 스키마 보강, SQL 주석 표준 변경, Reviewer/Linter 검증 Rule 확대 | 데이터설계총괄 |
